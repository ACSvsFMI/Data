    	...
    	<div id="Page" class="site_width center">
            ...
            <div class="wp-table">
            	<div class="th">
                    ...
                    <span class="td" style="width:390px;">Postare</span>
				...
				foreach($results as $row)
				{
					...
					echo '<section class="tr">';
                    	...
                    	echo '<div class="td" style="width:390px;">';
							echo '<div class="info"><h1><a href="'.$row["url_comm"].'" target="_blank">'.$row["fullname"].'</a></h1><span>Senior web la Hosting</span><div class="options"><a href="">Editeaza</a> <a href="">Sterge</a></div></div>';
						echo '</div>';
						echo '<div class="td" style="width:50px; line-height:64px;">999,999</div>';
                    	echo '<div class="td" style="width:50px; line-height:64px;">999,999</div>';
						echo '<div class="td" style="width:50px; line-height:64px;">999,999</div>';
						echo '<div class="td" style="width:100px;">'.$datainsert->format("H:i").' <strong>'.$datainsert->format("d M Y").'</strong><br /><span style="color:#666">'.Datatime::ago($datainsert->format("Y-m-d")).'</span><div class="options2"><a onclick="return gplus.client_update('.$row["id"].');" href="#">Actualizeaza</a></div></div>';
					echo '</section>';
				}
				?>
            </div>
